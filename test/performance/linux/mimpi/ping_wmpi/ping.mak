...
CLEAN :
	-@erase "$(INTDIR)\multipingpong.obj"
...
CLEAN :
	-@erase "$(INTDIR)\multipingpong.obj"
	-@erase "$(INTDIR)\multipingpong.sbr"
	-@erase "$(INTDIR)\timer.obj"
...
CPP_PROJ=/nologo /MDd /W3 /Gm /GX /ZI /Od /I "..\..\..\..\..\src" /I "..\..\..\..\..\include" /D "WIN32" /D "_DEBUG" /D "_CONSOLE" /D "_MBCS" /D "HAVE_CONFIG_H" /D "__DEBUG__" /D "HAVE_WINDOWS_H" /FR"$(INTDIR)\\" /Fp"$(INTDIR)\ping.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /GZ /c 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\ping.bsc" 
BSC32_SBRS= \
	"$(INTDIR)\timer.sbr" \
	"$(INTDIR)\multipingpong.sbr"
...
"$(INTDIR)\multipingpong.obj" : $(SOURCE) "$(INTDIR)"


!ELSEIF  "$(CFG)" == "ping - Win32 Debug"


"$(INTDIR)\multipingpong.obj"	"$(INTDIR)\multipingpong.sbr" : $(SOURCE) "$(INTDIR)"
